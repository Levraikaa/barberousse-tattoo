...
export default function LegalPage({
  ...
  return (
    <>
      <Navbar />
      <main id="contenu" className="pb-24 pt-36 md:pt-44">
        <article className="mx-auto w-full max-w-3xl px-6 md:px-8">
          <div className="mb-5 flex items-center gap-3">
            <span className="h-px w-10 bg-gold/60" aria-hidden="true" />
            <span className="text-xs uppercase tracking-[0.25em] text-gold-text">{eyebrow}</span>
          </div>
          ...
          <div
            className="legal mt-12 flex flex-col gap-10 text-white/85 [&_a]:underline [&_a]:decoration-white/25 [&_a]:underline-offset-4 [&_a:hover]:text-gold-text [&_h2]:text-xl [&_h2]:text-white [&_h2]:md:text-2xl [&_p]:mt-3 [&_p]:leading-relaxed [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:leading-relaxed"
            style={BODY_STYLE}
          >
            {children}
          </div>
